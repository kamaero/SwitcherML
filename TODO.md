...
- [ ] Hotkeys: ← undo последней замены, → пропуск автоконвертации для следующего слова
- [ ] Double-Shift только для конвертации выделенного текста
- [ ] Локализация UI на русский + окно настроек со скроллом
- [ ] Кнопка Help с краткой инструкцией
